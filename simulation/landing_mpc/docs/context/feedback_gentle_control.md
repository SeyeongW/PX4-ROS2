...
- To cut approach overshoot, lower `cruise_speed_m_s` or
  `los_rate_budget_deg_s` rather than raising position weights (`w_xy`) —
  raising the weight is the "high P gain" move and is what makes it snap.
